    ...
    function renderCompare2() {{
        ...
        container.innerHTML = `
            ...
            <div class="compare-grid">
                ...
                <div class="chart-container">
                    <div class="chart-title">🏢 Tin & Views theo thời gian</div>
                    <div class="chart-wrapper"><canvas id="cmp2Lines"></canvas></div>
                </div>
            </div>
            <div class="compare-grid">
                <div class="chart-container">
                    <div class="chart-title">💧 Views/Tin theo thời gian</div>
                    <div class="chart-wrapper"><canvas id="cmp2VTin"></canvas></div>
                </div>
            </div>
            <div class="compare-grid">
                <div class="chart-container">
        ...
        new Chart(document.getElementById('cmp2Lines'), {{
            ...
            data: {{
                labels: DATES,
                datasets: [
                    {{ label: r1+' Tin', data: d1.tin, borderColor: '#2563eb', borderWidth: 2.5, tension: 0.3, pointRadius: 4 }},
                    {{ label: r2+' Tin', data: d2.tin, borderColor: '#dc2626', borderWidth: 2.5, tension: 0.3, pointRadius: 4 }},
                    {{ label: r1+' Views', data: d1.views, borderColor: '#60a5fa', borderWidth: 1.5, tension: 0.3, borderDash: [5,5] }},
                    {{ label: r2+' Views', data: d2.views, borderColor: '#f87171', borderWidth: 1.5, tension: 0.3, borderDash: [5,5] }},
                ]
            }},
            options: {{
                ...
                scales: {{
                    y: {{ beginAtZero: true, grid: {{ color: 'rgba(99,102,241,0.05)' }}, title: {{ display: true, text: 'Số lượng' }} }},
        ...
        // Views/Tin chart
        cmpLineChart('cmp2VTin', 'views_tin', 'Views/Tin', '#22d3ee', '#fb923c');
