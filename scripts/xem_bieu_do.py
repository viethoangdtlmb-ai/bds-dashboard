    ...
    function renderCompare2() {{
        ...
        container.innerHTML = `
            ...
            <div class="compare-grid">
                ...
                <div class="chart-container">
                    <div class="chart-title">🏢 Tin, Views, Views/Tin theo thời gian</div>
                    <div class="chart-wrapper"><canvas id="cmp2Lines"></canvas></div>
                </div>
            </div>
            <div class="compare-grid">
                <div class="chart-container">
                    <div class="chart-title">💰 Giá (tr/m²) theo thời gian</div>
                    <div class="chart-wrapper"><canvas id="cmp2Gia"></canvas></div>
                </div>
            </div>
            <div class="compare-grid">
                <div class="chart-container">
        ...
        // Tin, Views, Views/Tin chart
        new Chart(document.getElementById('cmp2Lines'), {{
            type: DATES.length > 1 ? 'line' : 'bar',
            data: {{
                labels: DATES,
                datasets: [
                    {{ label: r1+' Tin', data: d1.tin, borderColor: '#2563eb', borderWidth: 2.5, tension: 0.3, yAxisID: 'y' }},
                    {{ label: r2+' Tin', data: d2.tin, borderColor: '#dc2626', borderWidth: 2.5, tension: 0.3, yAxisID: 'y' }},
                    {{ label: r1+' Views', data: d1.views, borderColor: '#60a5fa', borderWidth: 1.5, tension: 0.3, borderDash: [5,5], yAxisID: 'y' }},
                    {{ label: r2+' Views', data: d2.views, borderColor: '#f87171', borderWidth: 1.5, tension: 0.3, borderDash: [5,5], yAxisID: 'y' }},
                    {{ label: r1+' V/Tin', data: d1.views_tin, borderColor: '#22d3ee', borderWidth: 2, tension: 0.3, yAxisID: 'y1', pointStyle: 'rect' }},
                    {{ label: r2+' V/Tin', data: d2.views_tin, borderColor: '#fb923c', borderWidth: 2, tension: 0.3, yAxisID: 'y1', pointStyle: 'rect' }},
                ]
            }},
            options: {{
                responsive: true,
                ...
                scales: {{
                    y: {{ position: 'left', title: {{ display: true, text: 'Tin / Views' }}, grid: {{ color: 'rgba(99,102,241,0.05)' }} }},
        ...
        // Giá chart
        cmpLineChart('cmp2Gia', 'gia', 'Giá (tr/m²)', '#16a34a', '#e11d48');
